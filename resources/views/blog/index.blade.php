...
@php
    $articles = [
        ['title' => 'Belajar Laravel untuk Pemula', 'excerpt' => 'Panduan langkah demi langkah memulai Laravel, dari instalasi sampai deployment.', 'category' => 'Laravel', 'author' => 'Andi Wijaya', 'date' => '12 Agustus 2026', 'readTime' => '6 menit'],
        ['title' => 'Tailwind CSS: Utility-First yang Efisien', 'excerpt' => 'Mengapa Tailwind mempercepat development dan cara memulainya.', 'category' => 'CSS', 'author' => 'Sinta', 'date' => '8 Agustus 2026', 'readTime' => '4 menit'],
        ['title' => 'Membangun Admin Panel dengan Blade Component', 'excerpt' => 'Rakit admin panel modular pakai Blade component & Alpine.js.', 'category' => 'Laravel', 'author' => 'Andi Wijaya', 'date' => '2 Agustus 2026', 'readTime' => '8 menit'],
    ];
...
<x-layout.footer
    ...
    :links="[
        ...
        ['title' => 'Perusahaan', 'items' => [['label' => 'Tentang', 'href' => '#'], ['label' => 'Kontak', 'href' => '#kontak']]],
    ]"
    :socialLinks="[
