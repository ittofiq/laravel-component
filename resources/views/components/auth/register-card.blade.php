{{-- Komponen Register Card — form pendaftaran siap pakai --}}
@props([
    ...
    'termsLabel' => 'Saya setuju dengan syarat & ketentuan',
    'submitLabel' => 'Daftar',
...
<div class="w-full max-w-sm mx-auto">
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-lg p-6 lg:p-8">
        ...
        <form action="{{ $action }}" method="{{ $method }}" class="space-y-4">
            @csrf
            <x-form.input name="name" :label="$nameLabel" :placeholder="$namePlaceholder" :required="true" />
            ...
            <x-form.checkbox name="terms" :label="$termsLabel" />
