{{-- Komponen DateTime Input dengan Tailwind CSS --}}
@props([
    'name' => null,
    'label' => null,
    'value' => null,
...
@php
    $baseClasses = 'w-full px-4 py-2 rounded-lg border transition-colors duration-200 focus:outline-none focus:ring-2';
    $borderClasses = $error
