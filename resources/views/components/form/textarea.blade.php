...
<div x-data="{
    ...
    <div class="relative">
        ...
        <textarea
            ...
            class="w-full px-4 py-2 rounded-lg border transition-all duration-200 focus:outline-none focus:ring-2 {{ $autoResize ? 'resize-none' : 'resize-vertical' }} font-sans text-base
                {{ $error
